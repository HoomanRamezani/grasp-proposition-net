...
classes = list(category_ids.keys())
...
def main(args):
    ...
    testDataLoader = torch.utils.data.DataLoader(TEST_DATASET, batch_size=BATCH_SIZE, shuffle=False, num_workers=20,
                                                 pin_memory=True, drop_last=True)
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        with torch.no_grad():
            ...
            print("test samples", len(testDataLoader))
            ...
            print("loop labelweights", labelweights)
