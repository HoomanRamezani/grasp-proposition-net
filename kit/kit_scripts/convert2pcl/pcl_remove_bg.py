...
def processScene(scene_path):
    ...
    # for i in range(161): KIT EASY
    for i in range(9):  # KIT
...
if __name__ == "__main__":
    roots = ['/home/hooman.ramezani/grasp-detection/Pointnet_Pointnet2_pytorch/data/kit'] #['/pub2/y2863/data/kit', '/pub2/y2863/data/kit2']
